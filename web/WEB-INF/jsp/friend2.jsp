...
<div id="div1">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <c:forEach items="${list}" var="friendList">
                <tr height="38">
                    ...
                    <td id="td1">${friendList.linkPath}</td>
                    <td id="td1">
    ...
    <div id="div4">
        <p><br />&nbsp;&nbsp;&nbsp;保存友链</p>
        <form action="/friendLink/doUpdateFriendLink?id=${friendLink.id}&userId=${loginUser.id}" method="post">
            <table width="100%">
                <tr>
                    <td colspan="3" style="padding-top: 17px;padding-left: 17px;">
                        <input type="text" value="${friendLink.linkName}" placeholder="  请输入链接名称" name="linkName" style="height: 20px;"/>
                        <input type="text" value="${friendLink.linkPath}" placeholder="  请输入链接地址" name="linkPath" style="height: 20px;"/>
                        <input type="submit" value="修改链接" style="color: #fff;width: 80px;height: 25px;background-color: #41bd76;border: 0;"/>
                    </td>
                </tr>
            </table>
        </form>
