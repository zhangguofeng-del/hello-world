...
<body>
<div id="div1">
    <div id="div2"><span>编辑文章</span></div>
    <div id="div3">
        <form action="/bookManage/doUpdate?uId=${loginUser.id}" method="post">
            <table width="99%">
                <input type="text" name="id" value="${book.id}" hidden = "hidden">
                <tr>
                    <td><input type="text" name="title" placeholder="文章标题" value="${book.title}"/></td>
                    <td><input type="text" name="path" placeholder="自定义访问路径，如 my-first-article 默认为文章id" readonly="readonly"/></td>
                </tr>
                <tr style="line-height: 35px;">
                    <td height="35px"><input type="text" name="label" value="${book.label}" placeholder="请输入文章标签"/></td>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <textarea name="words" rows="20%" cols="90%" placeholder="文章内容区..." style="width: 99%;">${book.words}</textarea>
                    </td>
                </tr>
                <tr>
                ...
                <td colspan="2">
                    <div id="bottom">
                        ...
                        <input type="submit" value="修改" style="background-color: cornflowerblue;color: white"/>
                    </div>
                </td>
                </tr>
            </table>
